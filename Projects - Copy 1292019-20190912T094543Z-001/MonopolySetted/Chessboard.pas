...
begin
  ...
  begin
    Player[I].Position := 0;
    Player[I].Cash := 15000;
    Player[I].Assets := TStringList.Create;
  end;
...
begin
  ...
  begin
    ...
    //for I := Low(Player[CurrPlay].Assets) to High(Player[CurrPlay].Assets) do
      //Form2.ListBox2.Items.Add(Player[CurrPlay].Assets[I])
    Form2.ListBox2.Items := Player[CurrPlay].Assets;
  end;
end;
...
begin
  try
    ...
    Form2.Panel7.Caption := 'You stepped on '+PName+'.';

    if Form2.SQLQuery1.FieldByName('Special').AsInteger = 1 then
    begin
    ...
    begin
      if Form2.SQLQuery1.FieldByName('Owner').AsInteger = 0 then
      begin
  ...
  str(Player[CurrPlay].Position, PosStr);
  //Form2.Panel7.Caption := 'You stepped on square ' + PosStr + '.';
...
begin
  ...
  repeat
    ...
    //CheckCurrPos;
      Form2.StatList.Items.Add('Signaled');
